...
CREATE TABLE "shares" (
	...
	"role" "public"."share_role" DEFAULT 'view' NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX "shares_resource_user_idx" ON "shares" USING btree ("resource_type","resource_id","user_id");
--> statement-breakpoint
CREATE INDEX "shares_user_type_idx" ON "shares" USING btree ("user_id","resource_type");
